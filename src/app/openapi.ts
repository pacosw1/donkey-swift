...
function str(desc = ""): SchemaObj { return { type: "string", description: desc }; }
function strFmt(format: string, desc = ""): SchemaObj { return { type: "string", format, description: desc }; }
function int(desc = ""): SchemaObj { return { type: "integer", description: desc }; }
function intRange(min: number, max: number, desc = ""): SchemaObj { return { type: "integer", minimum: min, maximum: max, description: desc }; }
function bool(desc = ""): SchemaObj { return { type: "boolean", description: desc }; }
function arr(items: SchemaObj): SchemaObj { return { type: "array", items }; }
function ref(name: string): SchemaObj { return { $ref: `#/components/schemas/${name}` }; }
function obj(properties: Record<string, SchemaObj>, required?: string[]): SchemaObj {
  const s: SchemaObj = { type: "object", properties };
  if (required?.length) s.required = required;
  return s;
}
function strEnum(values: string[], desc = ""): SchemaObj { return { type: "string", enum: values, description: desc }; }
function nullStr(desc = ""): SchemaObj { return { type: ["string", "null"], description: desc }; }
function nullStrFmt(format: string, desc = ""): SchemaObj { return { type: ["string", "null"], format, description: desc }; }
...
interface RouteSpec {
  ...
  response: { status: number; description: string; schema?: SchemaObj };
}
...
function addRoute(paths: Record<string, Record<string, unknown>>, route: RouteSpec): void {
...
function engageRoutes(): RouteSpec[] {
  return [
    {
...
function notifyRoutes(): RouteSpec[] {
  return [
    {
...
function flagsRoutes(): RouteSpec[] {
  return [
    {
...
function receiptRoutes(): RouteSpec[] {
  return [
    {
...
function lifecycleRoutes(): RouteSpec[] {
  return [
    {
...
function accountRoutes(): RouteSpec[] {
  return [
    {
...
function attestRoutes(): RouteSpec[] {
  return [
    {
...
function paywallRoutes(): RouteSpec[] {
  return [
    {
...
function analyticsRoutes(): RouteSpec[] {
  return [
    {
...
function healthRoutes(): RouteSpec[] {
  return [
    {
...
function allSchemas(): Record<string, SchemaObj> {
  return {
    User: obj({
